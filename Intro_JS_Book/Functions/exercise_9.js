...
ANS: multiply, left, rigt
     product, left, rigt 
     getNumber, prompt
     left, getNumber
     right, getNumber
     left, right, multiply
    also just my two cents, question is not a varibale but a method from the readline-sync library

    Learning: console is the name of the varibale too !
